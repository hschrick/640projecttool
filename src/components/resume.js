  ...
  render(){
    return(
      ...
      <Cell className="Resume-right" col={8}>
       <h2 className="typistfont" style={{color: 'hotpink', fontSize: '35px'}}>High school Education Highlights 2011-2015</h2>
       <p  style={{color: '#22BAD9'}}>- Class on Introduction to programming in Java.<br/>
       ...
       <h2 className="typistfont" style={{color: 'hotpink', fontSize: '35px'}}>College Education 2015-2020</h2>
       <p style={{color: '#22BAD9'}}>
       ...
       <h2 className="typistfont" style={{color: 'hotpink', fontSize: '35px'}}>Work Experience</h2>
       <p style={{color: '#22BAD9'}}>
